// 来源：Dice UI color-picker（MIT）https://diceui.com/r/radix-vega/color-picker.json
// 适配：仅 import 路径改为本仓 shadcn 组件与本目录 hook；行为/焦点/ARIA 未改。登记见 docs/frontend/ui-assets/source-download-manifest.json
"use client";
